...
ggplot(selected,aes(x=score,y=-popularity_rank, color=dog_info, shape=smart, size=size_category)) + geom_point(alpha=.7) + geom_text(aes(label=`Dog breed`))
# ggsave("/tmp/plt.png", width = 34, height = 9, dpi = 120)
```
